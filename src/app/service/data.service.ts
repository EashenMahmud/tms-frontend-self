...
export class DataService {
  ...
  constructor(private http: HttpClient) {
    if (Cookie.check('.BBTMS.Cookie'))
      this.currentUserDetails = new BehaviorSubject<any>(JSON.parse(Cookie.get('.BBTMS.Cookie')));
  }
  ...
  login(params: any,) {
    ...
    return this.http.post<any>(environment.apiUrl + '/api/login', params).pipe(map(data => {
      ...
      if (data.status) {
        ...
        Cookie.set('.BBTMS.Cookie', JSON.stringify(user), expireDate, '/', window.location.hostname, false);
  ...
  detailsProject(id: any) {
    ...
    //   headers: headers
    // });
    return this.http.get(environment.apiUrl + `/api/project_with_projectAssign_and_user/` + id, {
      headers: headers
    });
  }
  ...
  taskList(id: any) {
    ...
    return this.http.get(environment.apiUrl + '/api/task-for-specific-project/' + id, {
      headers: headers
    });
  }
  uploadFile(id: any) {
  ...
  task_details(id: any) {
    ...
    //   headers: headers
    // });
    return this.http.get(environment.apiUrl + `/api/task-with-taskassign-and-user/` + id, {
      headers: headers
    });
  }
  task_for_images(task_id: any) {
    ...
    return this.http.get(environment.apiUrl + `/api/images-for-task/` + task_id, {
      headers: headers
    });
  }
  task_for_comments(task_id: any) {
    ...
    return this.http.get(environment.apiUrl + `/api/comments-for-task/` + task_id, {
      headers: headers,
    });
  }
  ...
  delete_a_file(file_id: any) {
    ...
    return this.http.delete(environment.apiUrl + `/api/delete-file/` + file_id, {
      headers: headers,
    });
  }
  updateUser(data: any) {
  ...
  taskUserImage(id: any) {
    const headers = new HttpHeaders({
      'Content-Type': 'application/json',
      Authorization: `Bearer ${localStorage.getItem('token')}`,
    });

    return this.http.get(environment.apiUrl + `/api/task-assign-image/` + id, {
      headers: headers,
    });
  }
