...
import { navbarData, navbarData2, navbarData3, navbarData4, navbarData5, navbarData6, navbarData7,  } from './nav-data';
...
export class SidenavComponent implements OnInit {
  ...
  type:any;
  expectedRole: string;
  constructor( private cookieService: CookieService, private RoleGuard: RoleGuard){
    // this.expectedRole = 'Admin';
    // this.expectedRole = 'Employee';
    this.expectedRole = 'Admin';
  }
